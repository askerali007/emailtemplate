    ...
    <nav class="navbar navbar-static-top">
      <div class="container">
        <div class="navbar-header">
          <a href="{{{URL::asset('/')}}}" class="navbar-brand"><b>Admin</b>LTE</a>
...
<!--            <li class="active"><a href="#">Link </a></li>-->
            ...
            <li class="dropdown">
              <a href="{{URL::asset('/users')}}" class="dropdown-toggle" data-toggle="dropdown">Users <span class="caret"></span></a>
            ...
            <li class="dropdown user user-menu">
              ...
              <ul class="dropdown-menu">
                ...
                <li class="user-footer">
                  <div class="pull-left">
                    <a href="{{{URL::asset('/user/profile')}}}" class="btn btn-default btn-flat">Profile</a>
                  </div>
                  <div class="pull-right">
                    <a href="{{{URL::asset('/logout')}}}" class="btn btn-default btn-flat">Sign out</a>
                  </div>
                </li>
              </ul>
            </li>
